...
class BaseWebUI(QMainWindow):
    def __init__(self, html, app, hub, debug=False):
        ...
        self.icon = self._getQIcon('hongbaominer_64x64.png')
...
class WebUI(BaseWebUI):
    def __init__(self, app, hub, debug=False):
        ...
        if sys.platform == 'darwin':
            tray_icon = 'hongbaominer_16x16_mac.png'
        elif sys.platform == "win32":
            tray_icon = 'hongbaominer_16x16.png'
        else:
            tray_icon = 'hongbaominer_32x32_ubuntu.png'
