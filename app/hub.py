        ...
        if pool_info['username'] == "":
            ...
            if result:
                ...
                QMessageBox.warning(self.ui, "Wallet Address Required", \
                    ...
                    Hint: You can get a new address from:<br><br><b>https://wallet.hongbao.com</b>")
...
#         self.add_pool_dialog.show()
    ...
    def add_edit_pool(self, pool_id, pool_display_name, pool_url, pool_username, pool_password, pool_algo):
        ...
        try:
            ...
            if not url.hostname:
                QMessageBox.warning(self.add_pool_dialog,'Add/Edit Pool Error', "Pool URL (e.g. pool.hongbao.com) is required.")
                return
            ...
            QMessageBox.warning(self.add_pool_dialog, 'Add/Edit Pool Error', "Invalid pool URL!<br><br>Pool URL must be in form of <b>URL:Port</b><br> like <b>pool.hongbao.com:3333</b>")
            return
        ...
        if pool_id == "":
            ...
            self.on_create_hongbao_pool_list_event.emit(json.dumps([_pool_info]), CPU_COUNT, sys.platform == "win32")
            self.add_pool_dialog.close()
...
#                 self.on_stop_mining_event.emit(pool_info["id"]) 
    ...
    def create_pool_list(self):
        ...
        self.on_create_hongbao_pool_list_event.emit(json.dumps(pool_list), CPU_COUNT, sys.platform == "win32")
    ...
    on_create_hongbao_pool_list_event = Signal(str, int, bool)
