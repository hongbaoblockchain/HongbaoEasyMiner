...
if __name__ == '__main__':
    ...
    # Cmd Example: 
    # python miner_cli.py -a cryptonight-light -o stratum+tcp://aeon.hongbaominer.com:3334 -u WmtuFrqE4gnFt1to3qUk3qDsC1LEuK6bqHY5L7HjMTjn8WMSaAGTvpLCbvj6W2phLuamkTGFAAMDmivhpQDH8Ker39DHJJhbd -p x -t 8 -P -d
    
    # Parse the command line
    parser = argparse.ArgumentParser(description = "HongbaoMiner for CryptoNode currency using the stratum protocol")
