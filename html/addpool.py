            ...
            <form class="form-horizontal" id="add_pool_form">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input type="text" id="pool_url" placeholder="e.g. pool.hongbao.com:3333 (required)" maxlength="512">
                        </div>
                    </div>
                     <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-xs-9 col-xs-offset-3">
                            ...
                            <label style="color:#999; padding-top: 15px; font-weight: normal; font-size: 90%">1. Select <strong>Cryptonight</strong> hashing algorithm for HB (HongbaoBlockchain), XMR (Monero) and many other cryptonote-based coins; select <strong>Cryptonight-Light</strong> for AEON coin</label>
                        </div>
                    </div>
                </fieldset>
            </form>
